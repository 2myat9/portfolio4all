...
export function Lights() {
  return (
    <>
      <spotLight color="#A7BEAE" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#A7BEAE" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#A7BEAE" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#1E2761" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#1E2761" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#B85042" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}

export function Icosahedron1() {
  return (
